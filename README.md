...
**To run this project:** 
* Download the Stable Diffusion (SD) model files: [coreml-stable-diffusion-v1-5-palettized_split_einsum_v2_compiled.zip](https://huggingface.co/apple/coreml-stable-diffusion-v1-5-palettized/blob/main/coreml-stable-diffusion-v1-5-palettized_split_einsum_v2_compiled.zip)
* Unzip and copy the entire folder into `/Resources`
